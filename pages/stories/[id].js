            ...
            <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
...

                {
                    story.url && <Link href={story.url}>
                        <a class="text-blue-600 hover:text-blue-700 transition duration-300 ease-in-out mb-4">{story.url}</a>
                    </Link>
                }

                {
                    story.text && <div class="border border-gray-200 text-gray-900"><br></br>{story.text}</div>
                }
                    ...
                    < ul class="bg-white rounded-lg border border-gray-200 text-gray-900" >
                        {
                            comments.map(comment => (
                                <li class={`${levelIndent[comment.level]} py-2 border-b border-gray-200 w-full`} >
